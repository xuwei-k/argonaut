...
object JsonExample extends ArgonautSpec {
  ...
  implicit val CodecCoin: CodecJson[Coin] = casecodec1(Coin.apply, a => Option(a.value))("value")
  implicit val CodecPerson: CodecJson[Person] = casecodec3(Person.apply, a => Option(Tuple.fromProductTyped(a)))("name", "age", "wallet")
